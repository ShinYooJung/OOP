...
Number *Complex::add(Number * num) {
     ...
     */
     if (num->types() == INTEGER) {
        int sum = this->real() + ((Integer*) num)->val();
        this->set_val(sum, this->imag());
        delete(num);
        return this;

    } else if (num->types() == FLOAT) {
        double sum = this->real() + ((Float*) num)->val();
        this->set_val(sum, this->imag());
        delete(num);
        return this;

    } else if (num->types() == COMPLEX) {
        double sum1 = this->real() + ((Complex*) num)->real();
	double sum2 = this->imag() + ((Complex*) num)->imag();
        this->set_val(sum1, sum2);
        delete(num);
        return this;
...
Number *Complex::mul(Number * num) {
     ...
     */
     if (num->types() == INTEGER) {
        int sum1 = this->real() * ((Integer*) num)->val();
        int sum2 = this->imag() * ((Integer*) num)->val();
	this->set_val(sum1, sum2);
        delete(num);
        return this;

    } else if (num->types() == FLOAT) {
        double sum1 = this->real() * ((Float*) num)->val();
        double sum2 = this->imag() * ((Float*) num)->val();
	this->set_val(sum1, sum2);
        delete(num);
        return this;
        ...
        double sum1 = this->real() * ((Complex*) num)->real()
		- this->imag() * ((Complex*) num)->imag();
        double sum2 = this->real() * ((Complex*) num)->imag()
		+ this->imag() * ((Complex*) num)->real();
        this->set_val(sum1, sum2);
        delete(num);
        return this;
